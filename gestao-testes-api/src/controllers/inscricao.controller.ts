...
export class InscricaoController {
  ...
  async find(
    ...
    return this.inscricaoRepository.find(filter);
  }
  ...
  async findById(
    ...
    @param.filter(Inscricao, {exclude: 'where'})
    filter?: FilterExcludingWhere<Inscricao>,
  ): Promise<Inscricao> {
    return this.inscricaoRepository.findById(id, filter);
  }
