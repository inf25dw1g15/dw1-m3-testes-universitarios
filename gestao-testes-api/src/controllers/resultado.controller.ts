...
export class ResultadoController {
  ...
  async find(
    ...
    return this.resultadoRepository.find(filter);
  }
  ...
  async findById(
    ...
    @param.filter(Resultado, {exclude: 'where'})
    filter?: FilterExcludingWhere<Resultado>,
  ): Promise<Resultado> {
    return this.resultadoRepository.findById(id, filter);
  }
